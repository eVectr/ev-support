           ...
           if(FileNames.length == 0)  {
            ...
            generateCaseNo().then(no => {
               ...
               // axios.post(`http://localhost:7788/fileupload`, formData,
                ...
                // ).then(res => { 
                 ...
                 axios.post(`http://54.165.185.4:7788/saveContact`, {UserId:JSON.parse(localStorage.user)._id, Transaction_Number, Name, Email, Subject, Message,
            ...
            generateCaseNo().then(no => {
                ...
                // .then(res => {})
                   ...
                   axios.post(`http://54.165.185.4:7788/saveContact`, {UserId:JSON.parse(localStorage.user)._id, Transaction_Number, Name, Email, Subject, Message, Case_No, 
